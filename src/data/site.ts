...
export const siteData: SiteData = {
  ...
  secondaryCtaLabel: 'Emergency Service - Call Now',
  ...
  heroImage: '/images/electrician-and-the-truck.png',
  ...
  theme: {
    ...
    accent: 'dodgerblue',
    // accentDark: '#a47020',
        accentDark: 'greenyellow',
    surfaceTint: '#1b2234',
    heroGradient: 'linear-gradient(135deg, #0c1018 0%, #161d2b 46%, #1e1a12 100%)',
  },
}
